                ...
                <div className="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                            {(['maleBroadcaster', 'gentleFemale', 'matureMale', 'livelyFemale', 'intellectualFemale', 'narrator'] as const).map((presetKey, idx) => {
                    ...
                    >
                        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-sm p-5 text-center border border-white/50">
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                {t('common.willOverwrite', { name: speaker })}<span className="font-medium text-gray-700">「{speaker}」</span>{tv('replaceWarning')}
                            </p>
