        ...
        <div className={containerClass}>
            ...
            <div className="flex gap-2 w-full justify-center flex-wrap">
                <button
                    ...
                    className="flex-1 min-w-[70px] px-2 py-1.5 bg-white border border-slate-200 rounded-lg text-xs text-slate-700 font-medium hover:border-green-300 hover:bg-green-50 hover:text-green-700 transition-all relative group whitespace-nowrap"
                >
                ...
                {onVoiceDesign && (
                    <button
                        ...
                        className="flex-1 min-w-[70px] px-2 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg text-xs font-medium hover:shadow-md transition-all whitespace-nowrap"
                    >
                        <div className="flex items-center justify-center gap-1">
                ...
                {onVoiceSelect && (
                    <button
                        ...
                        className="flex-1 min-w-[70px] px-2 py-1.5 bg-white border border-purple-200 rounded-lg text-xs text-purple-700 font-medium hover:border-purple-400 hover:bg-purple-50 transition-all whitespace-nowrap"
                    >
                        <div className="flex items-center justify-center gap-1">
                            <svg className="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
