...
export const POST = apiHandler(async (request: NextRequest) => {
    ...
    const { imageBase64, base64, type, extension } = body
    ...
    if (imageBase64) {
        ...
        if (!matches) {
            throw new ApiError('INVALID_PARAMS', { message: 'Invalid base64 format' })
        }
        ...
        throw new ApiError('INVALID_PARAMS', { message: 'Missing imageBase64 or (base64 + extension)' })
    }
